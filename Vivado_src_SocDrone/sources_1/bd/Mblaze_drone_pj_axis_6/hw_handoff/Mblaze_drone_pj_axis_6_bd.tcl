...
################################################################
# This is a generated script based on design: Mblaze_drone_pj_axis_6
#
...
# source Mblaze_drone_pj_axis_6_script.tcl
...
set design_name Mblaze_drone_pj_axis_6
...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set pwm_0 [ create_bd_port -dir O -from 3 -to 0 pwm_0 ]
  ...
  # Create instance: myip_drone_bldc_moto_0, and set properties
  set myip_drone_bldc_moto_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:myip_drone_bldc_motor_ctrl:1.0 myip_drone_bldc_moto_0 ]
  ...
  connect_bd_intf_net -intf_net microblaze_0_axi_periph_M03_AXI [get_bd_intf_pins microblaze_0_axi_periph/M03_AXI] [get_bd_intf_pins myip_drone_bldc_moto_0/S00_AXI]
  ...
  assign_bd_address -offset 0x44A00000 -range 0x00010000 -target_address_space [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs myip_drone_bldc_moto_0/S00_AXI/S00_AXI_reg] -force
